...
import com.hyve.knowledge.extraction.DocsChunk
...
class DocsIndexer(
    ...
    private fun buildDocsReferenceEdges(db: com.hyve.knowledge.core.db.KnowledgeDatabase, chunks: List<DocsChunk>) {
