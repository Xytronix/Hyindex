...
class ClientUiIndexer(private val ctx: IndexContext) {
    ...
    fun index(force: Boolean = false): IndexResult {
        ...
        val changes = hashTracker.detectChanges(
            ...
            fileFilter = { com.hyindex.knowledge.extraction.ClientUIParser.isIndexableClientFile(it) },
        )
    ...
    private fun buildUIBindsToEdges(db: com.hyindex.knowledge.core.db.KnowledgeDatabase, chunks: List<com.hyindex.knowledge.extraction.ClientUIChunk>) {
