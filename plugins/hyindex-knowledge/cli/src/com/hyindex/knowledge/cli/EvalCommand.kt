...
import com.hyindex.knowledge.core.eval.EvalRunner
import com.hyindex.knowledge.core.eval.GoldenQuery
import com.hyindex.knowledge.core.eval.GoldenSet
import com.hyindex.knowledge.core.eval.SweepGrid
import com.hyindex.knowledge.core.eval.ToolEval
...
data class EvalArgs(
    ...
    companion object {
        val USAGE = """
            Hyindex Knowledge Eval

            Usage: java -jar hyindex-knowledge-indexer.jar eval [options]
