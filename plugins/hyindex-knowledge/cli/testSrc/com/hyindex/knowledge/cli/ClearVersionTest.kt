...
class ClearVersionTest {
    ...
    private fun readVersion(dir: java.io.File): String? {
        val m = Class.forName("com.hyindex.knowledge.cli.IndexerMainKt")
    ...
    private fun snapshot(dir: java.io.File, v: String) {
        val m = Class.forName("com.hyindex.knowledge.cli.IndexerMainKt").getDeclaredMethod(
            "snapshotVersionIndex", java.io.File::class.java, String::class.java,
            com.hyindex.knowledge.core.logging.LogProvider::class.java)
        m.isAccessible = true
        m.invoke(null, dir, v, StdoutLogProvider)
    }
    @Test fun `reads recorded version`() {
        val d = Files.createTempDirectory("hyindex-ver").toFile()
    ...
    @Test fun `wipe deletes db hnsw and decompiled`() {
        val d = Files.createTempDirectory("hyindex-wipe").toFile()
    ...
    @Test fun `snapshots superseded version so it stays diffable`() {
        ...
        val base = Files.createTempDirectory("hyindex-snap").toFile()
